...
function Edit({project}) {
  ...
  //to check whether we can see in edit component
  console.log(project);
  ...
  //state to show preview of edit image
  ...
  const handleShow = () => {
    setShow(true);
    //to see the change when the modal is opened again
    setProjectData({id:project?._id,title:project?.title,language:project?.language,overview:project?.overview,github:project?.github,website:project?.website,projectImage:""})
  }
  ...
  const handleUpdateProject = async()=>{
    ...
    if(!title || !language || !overview || !github || !website){
      ...
      //creating token ; api call only if there is token
